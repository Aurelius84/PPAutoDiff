...
-   autodiff的输出信息：
    ...
    -   当模型对齐失败时，将输出：
        ...
        Paddle Stacks:
        =========================
                 File /workspace/env/env3.7/lib/python3.7/site-packages/ppautodiff-0.0.1-py3.7.egg/PPAutoDiff/stack_info.py: 37    extract_frame_summary
                        frame_summarys = traceback.StackSummary.extract(traceback.walk_stack(None))
                 File /workspace/env/env3.7/lib/python3.7/site-packages/ppautodiff-0.0.1-py3.7.egg/PPAutoDiff/autodiff.py: 74    layer_hook
                 ...
                 File /workspace/env/env3.7/lib/python3.7/site-packages/paddle/fluid/dygraph/layers.py: 1023    __call__
                        return self._dygraph_call_func(*inputs, **kwargs)
                 File /workspace/env/env3.7/lib/python3.7/site-packages/ppautodiff-0.0.1-py3.7.egg/PPAutoDiff/autodiff.py: 54    autodiff
        ...
        =========================
                 ...
                 File /workspace/env/env3.7/lib/python3.7/site-packages/ppautodiff-0.0.1-py3.7.egg/PPAutoDiff/autodiff.py: 43    autodiff
        ...
        /workspace/env/env3.7/lib/python3.7/site-packages/ppautodiff-0.0.1-py3.7.egg/PPAutoDiff/utils.py:110: UserWarning: Warning: duplicate key is found, use list + pop strategy.
